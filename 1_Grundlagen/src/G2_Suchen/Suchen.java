...
public class Suchen {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("bin�r:      "+gesuchterWert2+" steht an der Stelle "+index2);
        int indexStr2 = binaereSuche(sortierteNamen, gesuchterName2);
        System.out.println("bin�r:      "+gesuchterName2+" steht an der Stelle "+indexStr2);
    }
    
    /**
     * Durchsucht eine unsortiertes Feld nach einem Wert und
     * gibt den Index zur�ck, wenn der Wert gefunden wird.
     * Im Fehlerfall wird -1 zur�ckgegeben
     * @param feld
     * @param wert
     * @return
     */
    ...
    //�berladene Methode f�r die Sequentielle Suche in Feldern mit Zeichenketten
    ...
    */
    public static int binaereSuche(int[] sortiertesFeld, int wert){
        ...
        while (untereGrenze <= obereGrenze) {
            index = (untereGrenze+obereGrenze)/2;  //index in der Mitte w�hlen
            
            //Falls der Wert gefunden wurde
            if(sortiertesFeld[index]==wert)
                return index;
            //eine H�lfte w�hlen, wenn der Wert noch nicht gefunden wurde
