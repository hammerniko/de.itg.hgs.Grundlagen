...
public class Hangman {
	...
	public static void bestimmeDauer() {
	...
	public static String eingabeBuchstabe(int anzahl, Scanner s) {
		String eingegebeneZeichen;
	...
	public static String gibWort(String[] wortliste) {
	...
	public static void betimmeZwischenzeit() {
