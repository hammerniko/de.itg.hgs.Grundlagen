...
public class B1_3_Mehrfachverzweigung {
    ...
    public static void main(String[] args) {
        ...
        if 		(gewicht > 100 ){ 	meldungElseIf="schwer"; }
        else if	(gewicht > 90)	{ 	meldungElseIf="üppig";  }
        else					{	meldungElseIf="normal"; }
        
        //prüfung mit mehreren if
        if 		(gewicht > 100 ){ meldungIf="schwer";       }
        if		(gewicht >90 )	{ meldungIf="üppig";		}
        else					{ meldungIf="normal";		}
